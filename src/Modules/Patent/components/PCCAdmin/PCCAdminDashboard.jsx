  ...
  <Paper shadow="md" radius="lg" className="combined-section">
    ...
    <Box className="overview-section">
      ...
      <Text className="overview-text">
        ...
        and manufacturing, as well as the design of IT systems. Welcome to the PCC Admin Dashboard. Here, you can manage 
       applications, track their status, access important resources and view insights.
      </Text>
    </Box>
