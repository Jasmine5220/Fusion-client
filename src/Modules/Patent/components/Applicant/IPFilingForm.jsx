...
function IPFilingForm() {
  ...
  const FormField = ({ heading, value, isMobile}) => (
    <div className={`form-field ${isMobile ? "mobile-form-field" : ""}`}>
      <Text
        className={`field-heading ${isMobile ? "mobile-field-heading" : ""}`}
      >
        {heading}
      </Text>
  ...
  const Inventor = ({ inventor, index, isMobile }) => (
    <div
      className={`inventor-container ${isMobile ? "mobile-inventor-container" : ""}`}
    >
      <Text
        className={`inventor-title ${isMobile ? "mobile-inventor-title" : ""}`}
      >
        Inventor {index + 1}
      </Text>
  ...
  const FormActions = ({ isMobile }) => (
    <div className={`form-actions ${isMobile ? "mobile-form-actions" : ""}`}>
      <Button
        leftIcon={<DownloadSimple size={isMobile ? 18 : 20} />}
  ...
  const MainForm = ({ isMobile }) => (
    ...
    >
      ...
      <FormSection
        title="Section I: Administrative and Technical Details"
        isMobile={isMobile}
      >
        <FormField
          heading="Title of Application:"
          value="AI-Based Disease Detection in Crops"
          isMobile={isMobile}
        />
        <Text
          className={`field-group-title ${isMobile ? "mobile-field-group-title" : ""}`}
        >
        ...
        <FormField
          heading="Area of the invention:"
          value="Agricultural Technology and AI"
          isMobile={isMobile}
        />
        <FormField
          heading="Problem in the area:"
          value="Lack of efficient and affordable disease detection tools for farmers."
          isMobile={isMobile}
        />
        <FormField
          heading="Objective of your invention:"
          value="To develop an affordable and accurate AI-driven tool for disease diagnosis in crops."
          isMobile={isMobile}
        />
        <FormField
          heading="Novelty:"
          value="The first AI model optimized for real-time, edge-device use in the field."
          isMobile={isMobile}
        />
      </FormSection>
      ...
      <FormSection title="Section II: IPR Ownership" isMobile={isMobile}>
        <FormField
          heading="Significant use of funds/facilities:"
          value="Yes, using IIITDM Jabalpur's research facilities."
          isMobile={isMobile}
        />
        <FormField
          heading="Source of funding:"
          value="Institute's research grant"
          isMobile={isMobile}
        />
        <FormField
          heading="Journal/Conference Presentation:"
          value="Presented at AI & Agriculture 2024 Conference."
          isMobile={isMobile}
        />
        <FormField
          heading="MOU or Agreement Details:"
          value="Sponsored under IIITDM Research Fund (MOU #12345)."
          isMobile={isMobile}
        />
      </FormSection>
      ...
      <FormSection title="Section III: Commercialization" isMobile={isMobile}>
        <FormField
          heading="Target Companies:"
          value="Monsanto India, Agrotech Pvt Ltd, and Agribots Inc."
          isMobile={isMobile}
        />
        <FormField
        ...
        />
        <FormField
          heading="Uploaded duly filled and signed Form-III:"
          value={
            <Button
              component="a"
      ...
      <FormSection title="Dates and Status" isMobile={isMobile}>
        ...
        />
        <FormField
          heading="Attorney Assigned:"
          value="18 November 2024"
          isMobile={isMobile}
        />
        <FormField
